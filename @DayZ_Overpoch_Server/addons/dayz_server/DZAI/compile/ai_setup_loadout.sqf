private ["_cash","_unit","_weapongrade","_weapons","_weapon","_magazine","_backpacks","_gadgetsArray","_backpack","_gadget","_inventory"];
...
_cash = round(random 50) * 20000; // adds money to ai wallets in 20000x increments. 
