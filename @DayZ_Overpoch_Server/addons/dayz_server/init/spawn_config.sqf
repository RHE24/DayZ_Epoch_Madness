...
class_private = [ // These are only visible to players in their respective class levels
	...
	["VIP Sniper","Sniper1_DZ","SurvivorW2_DZ",["5Rnd_127x99_AS50",2,"17Rnd_9x19_glock17",4,VIP_ITEMS],["BAF_AS50_TWS","G17_SD_MFL_DZ","Binocular_Vector"],"DZ_LargeGunBag_EP1",[],[],3,5000,250000,"MeleeHatchet"]
];
class_customLoadout = [
...
class_customLoadouts = [ // These are only visible to their owner
	["Mike's Loadout","Sniper1_DZ","SurvivorW2_DZ",["20Rnd_762x51_SB_SCAR",2,"5Rnd_127x99_AS50",2,"17Rnd_9x19_glock17",4,"1Rnd_HE_M203",VIP_ITEMS],["SCAR_H_STD_TWS_SD","G17_SD_MFL_DZ",VIP_TOOLS],"DZ_LargeGunBag_EP1",["20Rnd_762x51_SB_SCAR",2,"10Rnd_127x99_m107",2,"5Rnd_127x99_AS50",2,"ItemWaterBottleBoiled","fuel_pump_kit","FoodRabbitCooked",2,"FishCookedTuna",2],["m107_TWS_EP1"],3,5000,250000,"BAF_AS50_TWS"],
	[],
	[]
];
