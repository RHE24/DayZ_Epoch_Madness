...
dayZ_serverName = "DOM"; //Shown to all players in the bottom left of the screen (country code + server number)
...
DZE_PlotPole = [90,120]; // Radius owned by plot pole [Regular objects,Other plotpoles]. Difference between them is the minimum buffer between bases.
...
MaxDynamicDebris = 125; // Max number of random road blocks to spawn around the map
...
EpochEvents = [["any","any","any","any",10,"weedfarm"],["any","any","any","any",30,"crash_spawner"],["any","any","any","any",0,"crash_spawner"],["any","any","any","any",15,"supply_drop"]];
...
if (!isDedicated) then {
	...
	[] execVM "dayz_code\DZAI_Client\dzai_initclient.sqf"; //DZAI Client Files Radio Messages
