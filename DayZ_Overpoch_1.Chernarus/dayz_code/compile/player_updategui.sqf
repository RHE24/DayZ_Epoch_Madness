...
_combatVal = if (player getVariable["combattimeout",0] >= diag_tickTime) then {0} else {1}; // May change later to be a range of red/green to loosely indicate 'time left in combat'
