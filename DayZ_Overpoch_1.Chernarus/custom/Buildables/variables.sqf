...
Admin_Crafting = ["76561197987495141"]; //old"98107654"
AAC_1=false;
AAC_2=false;
AAC_3=false;
...
_Topaz = _Defenses + _Forts + _Tents + _Towers + _fuel + _Mounted_Weapons;
...
DZE_maintainClasses = DZE_maintainClasses + _CraftingArray + workshop + ["ModularItems","DZE_Housebase","LightPole_DZ","BuiltItems","Generator_DZ","DZ_buildables","Plastic_Pole_EP1_DZ","Fence_corrugated_DZ","CanvasHut_DZ","ParkBench_DZ","MetalGate_DZ","StickFence_DZ","DesertCamoNet_DZ","ForestCamoNet_DZ","DesertLargeCamoNet_DZ","ForestLargeCamoNet_DZ","DeerStand_DZ","Scaffolding_DZ","FireBarrel_DZ","M240Nest_DZ"];
