...
parameters: _obj
*/
private ["_isallowedremove","_is_Removable",""
...
_isallowedremove = false;//Workshop
...
_is_Removable = _objType in DZE_Workshop;//Workshop
...
if (!_isallowedremove && _is_Removable) exitWith {DZE_ActionInProgress = false; cutText [format["You're not allowed to remove (%1)",_nameVehicle], "PLAIN DOWN"]; }; //Workshop
