...
_hasitem = [["ItemSandbag",6]] call player_checkItems;
...
[format["You need 6x Sandbags"], "PLAIN DOWN"];
dayz_actionInProgress = false;
};
...
_classname =  "Land_fort_bagfence_corner";    
...
sleep 3;
_removed = [["ItemSandbag",6]] call player_removeItems;     
				...
				_tmpbuilt setVariable ["OEMPos",_location,true]; //store original location as a variable
				 ...
				 //if not lockable item
					...
					_tmpbuilt setVariable ["CharacterID",dayz_characterID,true];
						...
						cutText [format["You now have better cover!"], "PLAIN DOWN",3];
					};
