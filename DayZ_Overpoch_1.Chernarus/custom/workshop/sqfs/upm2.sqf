...
private ["_nearRestr2","_playerPos","_nearRestr","_hastool","_hasitem","_removed","_abort","_reason","_distance","_isNear","_lockable","_isAllowedUnderGround","_offset","_classname","_zheightdirection","_zheightchanged","_rotate","_objectHelperPos","_objectHelperDir","_objHDiff","_position","_isOk","_dir","_vector","_cancel","_location2","_buildOffset","_location","_limit","_started","_finished","_animState","_isMedic","_proceed","_counter","_dis","_sfx","_combination_1_Display","_combination_1","_combination_2","_combination_3","_combination","_combinationDisplay","_combination_4","_num_removed","_tmpbuilt","_vUp","_classnametmp","_text","_ghost","_objectHelper","_location1","_object","_helperColor","_canDo","_pos","_onLadder","_vehicle","_inVehicle","_needNear","_canBuild"];
...
_hasitem = [["ItemPole",4], ["PartGeneric",4],["100Rnd_127x99_M2",3]] call player_checkItems;

_playerPos = getPosATL player;
_nearRestr = count nearestObjects [_playerPos, ["Plastic_Pole_EP1_DZ"], 27] > 0;
_nearRestr2 = count nearestObjects [_playerPos, ["M2StaticMG_US_EP1"], 45] > 0;


if !(_nearRestr) exitWith {
dayz_actionInProgress = false;
cutText [format["You need to be within plot pole range"], "PLAIN DOWN"];
};
...
[format["You need 4x ItemPole + x4PartGeneric +3x 100Rnd_127x99_M2"], "PLAIN DOWN"];
dayz_actionInProgress = false;
};
...
sleep 3;
_removed = [["ItemPole",4], ["PartGeneric",4],["100Rnd_127x99_M2",3]] call player_removeItems;      
			...
			if (isNumber (configFile >> "CfgVehicles" >> _classname >> "constructioncount")) then {
				...
				_tmpbuilt setVariable ["OEMPos",_location,true]; //store original location as a variable
				 ...
				 //if not lockable item
					...
					cutText [format["You are the new John Rambo!"], "PLAIN DOWN",3];
					};
