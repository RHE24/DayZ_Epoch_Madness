if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_static_array				= [["aimingAccuracy",0.20],["aimingShake",0.80],["aimingSpeed",0.35],["endurance",0.80],["spotDistance",0.60],["spotTime",0.45],["courage",0.95],["reloadSpeed",0.75],["commanding",0.70],["general",0.60]];

		ai_gear0					= [["ItemBandage","ItemBandage","ItemAntibiotic"],["ItemRadio","ItemMachete","ItemCrowbar","ItemKeyKit"]];
		...
		ai_wep_machine				= ["RPK_74","MK_48_DZ","M249_EP1_DZ","Pecheneg_DZ","M240_DZ","SCAR_L_STD_EGLM_TWS","SCAR_H_CQC_CCO","SCAR_H_STD_EGLM_Spect"];	// Light machine guns
		ai_wep_sniper				= ["M14_EP1","SCAR_H_LNG_Sniper_SD","M110_NVG_EP1","SVD_CAMO","VSS_Vintorez","DMR_DZ","M40A3","SCAR_H_LNG_Sniper","SCAR_H_LNG_Sniper_SD","SCAR_H_CQC_CCO_SD","M107_DZ","m107_TWS_EP1","M110_TWS_EP1","BAF_AS50_TWS","BAF_AS50_scoped_DZ"];	// Sniper rifles
		ai_wep_random				= [ai_wep_assault,ai_wep_sniper,ai_wep_machine,ai_wep_assault,ai_wep_assault];	// random weapon 60% chance assault rifle,20% light machine gun,20% sniper rifle
	...
	/* WAI MISSIONS CONFIG */
		...
		// Vehicle arrays
		armed_vehicle 				= ["ArmoredSUV_PMC","T90","GAZ_Vodnik_DZE","HMMWV_M1151_M2_CZ_DES_EP1_DZE","HMMWV_M998A2_SOV_DES_EP1_DZE","LandRover_MG_TK_EP1_DZE","LandRover_Special_CZ_EP1_DZE","Pickup_PK_GUE_DZE","Pickup_PK_INS_DZE","Pickup_PK_TK_GUE_EP1_DZE","UAZ_MG_TK_EP1_DZE"];
		armed_chopper 				= ["CH_47F_EP1_DZE","UH1H_DZE","Mi17_DZE","UH60M_EP1_DZE","UH1Y_DZE","UH1Y","MH60S_DZE","AH64D","AH64D_EP1","BAF_Apache_AH1_D","Mi24_D_TK_EP1"];
