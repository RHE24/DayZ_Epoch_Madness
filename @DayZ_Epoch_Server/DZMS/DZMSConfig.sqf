...
DZMSLargeVic = ["ArmoredSUV_PMC_DZE","Pickup_PK_INS_DZE","HMMWV_M1151_M2_CZ_DES_EP1_DZE","Ural_TK_CIV_EP1","Ural_INS"];
...
DZMSBlacklistZones = [
	[[06325,07807,0],300] //Starry Sobor
];
