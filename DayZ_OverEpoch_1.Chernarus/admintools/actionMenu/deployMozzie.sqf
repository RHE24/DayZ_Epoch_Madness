...
if((_hasItems && _hasTools && EAT_RequireToolBoxMozzie && EAT_RequirePartsMozzie) || (!EAT_RequireToolBoxMozzie && EAT_RequirePartsMozzie && _hasItems) || (!EAT_RequireToolBoxMozzie && EAT_RequirePartsMozzie && _hasTools) || (!EAT_RequireToolBoxMozzie && !EAT_RequirePartsMozzie)) then {
	hasMozzieItem = true;
} else { 
	hasMozzieItem = false;
