...
_nearRestr = count nearestObjects [_playerPos, ["MAP_parabola_big"], 25] > 0;

player playActionNow "Medic";
[player,"repair",0,false,10] call dayz_zombieSpeak;
[player,10,true,(getPosATL player)] spawn player_alertZombies;
sleep 2;
_delobj = nearestObject [player, "MAP_parabola_big"];
...
titleText ["Antenna removed", "PLAIN DOWN"];titleFadeOut 5;