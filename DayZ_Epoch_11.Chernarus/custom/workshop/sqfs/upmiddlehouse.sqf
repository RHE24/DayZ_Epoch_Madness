...
if (_Playersurvived < 4) exitWith {
cutText [format["Can't yet! You've only survived %1 days. You'll need to survive 4 full days",_Playersurvived], "PLAIN DOWN"]; 
...
cutText [format["You cannot build another House in this plot area"], "PLAIN DOWN"];  
    dayz_actionInProgress = false;
	};
...
cutText [format["Great work! You built a medium sized home!"], "PLAIN DOWN",3];
					};
