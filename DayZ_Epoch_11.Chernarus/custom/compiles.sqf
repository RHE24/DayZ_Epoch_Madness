...
if (!isDedicated) then {
	...
	zombie_generate = 			compile preprocessFileLineNumbers "zupa\walkers\zombie_generate.sqf";			//Server compile, used for loiter behaviour
	wild_spawnZombies = 		compile preprocessFileLineNumbers "zupa\walkers\wild_spawnZombies.sqf";			//Server compile, used for loiter behaviour
