...
_nearRestr2 = count nearestObjects [_playerPos, ["MAP_AirCondition_A"], 45] > 0;
...
cutText [format["You cannot build another Portable Table Saw in this area 145mts"], "PLAIN DOWN"];  
    dayz_actionInProgress = false;
    };
				...
				_tmpbuilt setVariable ["OEMPos",_location,true]; //store original location as a variable
				 ...
				 //if not lockable item
					...
					_tmpbuilt setVariable ["CharacterID",dayz_characterID,true];
						...
						cutText [format["Use the Portable Table Saw to quickly craft wooden objects"], "PLAIN DOWN",3];	
					};
