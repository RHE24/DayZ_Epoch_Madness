...
_nearRestr2 = count nearestObjects [_playerPos, ["MAP_Camo_Box"], 145] > 0;
...
cutText [format["You cannot build another Portable Cammo net in this area 145mts"], "PLAIN DOWN"];  
    dayz_actionInProgress = false;
    };
				...
				_tmpbuilt setVariable ["OEMPos",_location,true]; //store original location as a variable
				 ...
				 //if not lockable item
					...
					_tmpbuilt setVariable ["CharacterID",dayz_characterID,true];
						...
						cutText [format["A Small cammo net"], "PLAIN DOWN",3];	
					};
