...
_hasitems = [["PartWoodPile",8]] call player_checkItems;
...
if !(_hasitems) exitWith {
	cutText [format["Needs 8xWoodPiles in your inventory."], "PLAIN DOWN"];
	dayz_actionInProgress = false;
};
...
sleep 5;
_removed = [["PartWoodPile",8]] call player_removeItems;	
player addMagazine "stick_fence_kit";
player addMagazine "stick_fence_kit";
player addMagazine "stick_fence_kit";
...
sleep 1;
titleText ["Craft 3xStickFence!! 8xWoodPile was removed!", "PLAIN DOWN"];titleFadeOut 5;
};
