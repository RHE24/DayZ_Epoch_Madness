...
_nearRestr2 = count nearestObjects [_playerPos, ["SatPhone"], 145] > 0;
...
cutText [format["You cannot build another Portable Engineering  in this area 145mts"], "PLAIN DOWN"];  
    dayz_actionInProgress = false;
    };
						...
						if (DZE_permanentPlot) then {
							_tmpbuilt setVariable ["ownerPUID",dayz_playerUID,true];
								...
								publicVariableServer "PVDZ_obj_Publish";
											systemChat("wait some seconds trying to find frecuencys");
                                           sleep 6;
					[] execVM 'custom\portables\communications_init.sqf';	
					};
