...
cutText [format["Needs a Portable Table Saw less than 5mts"], "PLAIN DOWN"];  
...
sleep 1;
titleText ["Craft 1xItem Wood Wall!! 9xPlywoodPack+3xlumberpack was removed!", "PLAIN DOWN"];titleFadeOut 5;
};
