...
_hasitems = [["PartWoodPlywood",12]] call player_checkItems;
...
if !(_hasitems) exitWith {
	cutText [format["Needs 12xPlywoods in your inventory."], "PLAIN DOWN"];
	dayz_actionInProgress = false;
};
...
sleep 5;
_removed = [["PartWoodPlywood",12]] call player_removeItems;	
player addMagazine "PartPlywoodPack";
player addMagazine "PartPlywoodPack";
player addMagazine "PartPlywoodPack";
player addMagazine "PartPlywoodPack";
player addMagazine "PartPlywoodPack";
...
sleep 1;
titleText ["Craft 6xPlywoodPacks!! 12xplywoods was removed!", "PLAIN DOWN"];titleFadeOut 5;
};
