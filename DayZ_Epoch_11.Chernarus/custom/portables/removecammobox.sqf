...
_nearRestr = count nearestObjects [_playerPos, ["MAP_Camo_Box"], 25] > 0;

player playActionNow "Medic";
[player,"repair",0,false,10] call dayz_zombieSpeak;
[player,10,true,(getPosATL player)] spawn player_alertZombies;
sleep 2;
_delobj = nearestObject [player, "MAP_Camo_Box"];
...
titleText ["Portable cammo box was removed", "PLAIN DOWN"];titleFadeOut 5;

_backpack  = createVehicle ["DZ_Patrol_Pack_EP1",getpos player,[], 0, ""];
