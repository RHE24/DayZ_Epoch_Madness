...
*/
#define VIP_ITEMS "ItemAntibiotic","ItemBloodbag","ItemMorphine" // constant example, these can be removed if they are not used below
#define VIP_TOOLS "Binocular_Vector","NVGoggles","ItemCompass","ItemKnife","ItemKeyKit","ItemEtool","ItemWatch","ItemGPS","ItemCrowbar","ItemRadio"

_currencyVariable = "cashMoney"; // Coins variable name
_startBag = "DZ_Patrol_Pack_EP1"; // Use "" for none
_startMags = ["ItemBandage",4,"ItemPainkiller","ItemWaterbottle","FoodRabbitCooked","15Rnd_9x19_M9SD"];
_startWeps = ["ItemMap","ItemFlashlight","ItemToolbox","M9SD"];
_customLoadout = [
...
_customLoadouts = [
	["Mike's Loadout","Sniper1_DZ","BanditW2_DZ",["10Rnd_127x99_m107",4,"15Rnd_9x19_M9SD",3,VIP_ITEMS],["PMC_AS50_TWS",VIP_TOOLS],"DZ_LargeGunBag_EP1",["Itemmatchbox","10Rnd_127x99_m107",4],["m107_TWS_EP1"],3,1000,1500000],
	[],
	[]
];
