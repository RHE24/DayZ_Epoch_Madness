...
ATMDialogWithdrawAmount = {
	...
	if (_amount > 950000000) exitWith {"You can not withdraw more than 950,000,000 coins at once." call dayz_rollingMessages};
...
ATMDialogDepositAmount = {
	...
	if (_amount > 950000000) exitWith {"You can not deposit more than 950,000,000 coins at once." call dayz_rollingMessages};
