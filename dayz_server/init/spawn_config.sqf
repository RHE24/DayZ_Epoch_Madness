...
*/
class_level1 = ["76561197987495141","0","0"];
class_level2 = ["76561197987495141","0","0"];
class_level3 = ["76561197987495141","0","0"];
...
#define VIP_ITEMS "ItemBandage",4,"ItemPainkiller","ItemWaterBottleBoiled","FoodRabbitCooked","ItemAntibiotic","ItemBloodbag","ItemMorphine" // constant example, these can be removed if they are not used below
#define VIP_TOOLS "Binocular_Vector","NVGoggles_DZE","ItemCompass","ItemKnife","ItemMatchBox","ItemEtool","ItemFlashlightRed","ItemWatch","ItemGPS","Map_Military_DZE","ItemToolBox","ItemCrowBar","ItemRadio","ItemKeyKit"
class_private = [ // These are only visible to players in their respective class levels
	["VIP Scout","Camo1_DZ","SurvivorW2_DZ",["30Rnd_556x45_Stanag",2,"15Rnd_9x19_M9SD",3,VIP_ITEMS],["M16A4_ACOG_DZ","M9_SD_DZ","Binocular_Vector"],"DZ_ALICE_Pack_EP1",[],[],1,1500,100000,"MeleeHatchet"],
	["VIP Specialist","Rocket_DZ","SurvivorW2_DZ",["100Rnd_762x51_M240",2,"15Rnd_9x19_M9SD",3,VIP_ITEMS],["Mk48_CCO_DZ","M9_SD_DZ","Binocular_Vector"],"DZ_British_ACU",[],[],2,2500,150000,"MeleeHatchet"],
	["VIP Sniper","Sniper1_DZ","SurvivorW2_DZ",["5Rnd_127x99_AS50",2,"17Rnd_9x19_glock17",4,VIP_ITEMS],["BAF_AS50_TWS","G17_DZ","Binocular_Vector"],"DZ_LargeGunBag_EP1",[],[],3,5000,250000,"MeleeHatchet"]
];
class_customLoadout = [
...
class_customLoadouts = [ // These are only visible to their owner
	["Mike's Loadout","Sniper1_DZ","SurvivorW2_DZ",["20Rnd_762x51_B_SCAR",2,"5Rnd_127x99_AS50",2,"17Rnd_9x19_glock17",4,"1Rnd_HE_M203",VIP_ITEMS],["SCAR_H_STD_EGLM_Spect","G17_DZ",VIP_TOOLS],"DZ_LargeGunBag_EP1",["20Rnd_762x51_B_SCAR",4,"10Rnd_127x99_m107",4,"5Rnd_127x99_AS50",4,"ItemWaterBottleBoiled",2,"fuel_pump_kit","FoodRabbitCooked",2,"FishCookedTuna",2,"plot_pole_kit"],["m107_TWS_EP1"],3,5000,1250000,"BAF_AS50_TWS"],
	[],
	[]
];

spawn_level1 = ["76561197987495141","0","0"];
spawn_level2 = ["76561197987495141","0","0"];
spawn_level3 = ["76561197987495141","0","0"];
