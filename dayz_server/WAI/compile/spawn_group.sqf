if (isServer) then {
    ...
    private ["_rocket","_launcher","_pos_x","_pos_y","_pos_z","_aiskin","_unarmed","_current_time","_gain","_ainum","_aitype","_mission","_aipack","_aicskill","_position","_unitnumber","_skill","_gun","_mags","_backpack","_skin","_gear","_aiweapon","_aigear","_aiskin","_skillarray","_unitGroup","_weapon","_magazine","_gearmagazines","_geartools","_unit"];
	...
	for "_x" from 1 to _unitnumber do {
		...
		if (!_unarmed) then {
			...
			//Zupa Coins on AI
			_cash = round(random 20) * 20000; // number between 0 and 20 000
